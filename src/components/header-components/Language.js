  ...
  return (
    <div className="language">
      <div className="choose-lang lang-dk" onClick={chooseLang}>
        <img src={DK} className="flag dk" id="flag-dk" alt="dansk" />
      </div>
      <div className="choose-lang lang-eng" onClick={chooseLang}>
        <img src={GB} className="flag eng" id="flag-eng" alt="english" />
      </div>
      <div className="choose-lang lang-es" onClick={chooseLang}>
        <img src={ES} className="flag es" id="flag.es" alt="Español" />
      </div>
      <div className="choose-lang lang-de" onClick={chooseLang}>
        <img src={DE} className="flag de" id="flag-de" alt="deutsch" />
      </div>
    </div>
  );
}
